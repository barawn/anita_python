...
for GLITC_i in range(1):
	...
	for channel_i in range(1,2):
		...
		pp = None#PdfPages('/home/user/data/GLITC_%d/threshold_study/G%d_Ch%d_input_scan_samples_%s.pdf'%(GLITC_i,GLITC_i,channel_i,file_iterator))
